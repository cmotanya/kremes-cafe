...
const HomePage = () => {
  ...
  return (
    <section id="#home" className="relative h-dvh w-full">
      ...
      <div className="relative z-20 h-full items-center justify-center pt-28 md:mt-0 md:flex">
        <div className="container mx-auto grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="mx-auto mt-8 flex w-1/2 items-center justify-between gap-4"
            >
              <Button asChild>
                <Link href={"/menu"}>
                  {" "}
